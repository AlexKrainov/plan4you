...
namespace plan2plan.Controllers
{
    ...
    {
        private plat2platContext db = new plat2platContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Description,FileName,Path,PreviewPath_min,PreviewPath_avg,PreviewPath_max,isDelete,isShow,isExist")] File file)
        {
