$(function () {
    ...
    $.get("http://freegeoip.net/json/", function (response) {
        statistics.person_data.ip = response.ip;
        ...
        statistics.person_data.browser_name = window.jscd.browser;
        ...
        statistics.send_data_to_server();
    });
});
 ...
 */
    ...
    send_data_to_server: function () {
        if (sessionStorage.getItem("session_id") == null) {
            $.ajax({
                url: '/Statistics/SaveInfo',
                data: statistics.person_data,
                type: "POST"
